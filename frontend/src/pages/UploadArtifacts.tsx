      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        <div>
          ...
          <p className="text-gray-400 mb-8">
            ...
            JSON, and System Logs. Files will be automatically segregated and
            analyzed.
          </p>
        </div>
          ...
          <>
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-400">
                          Score: {resultData.final.risk_score.toFixed(1)}/100 |{" "}
                          {resultData.final.risk_level}
                        </p>
                      </div>
                      <button
                        onClick={() =>
            ...
            >
              ...
              <p className="text-xs text-gray-500 mt-4">
                Supported: Images, Audio, Video, PDF, Word, Text, JSON, Logs,
                CSV, PCAP
              </p>
            </motion.div>
                          ...
                          {isAnalyzing && (
                            ...
                            >
                              ...
                              <p className="text-xs text-gray-400 mt-3 text-center">
                                {currentLayer[fileId] === 0 &&
                                  "Starting analysis..."}
                                {currentLayer[fileId] === 1 &&
                                  "Analyzing Layer 0 (Privacy)..."}
                                {currentLayer[fileId] === 2 &&
                                  "Analyzing Layer 1 (Heuristics)..."}
                                {currentLayer[fileId] === 3 &&
                                  "Analyzing Layer 2 (ML)..."}
                                {currentLayer[fileId] === 4 &&
                                  "Processing Layer 3 (LLM)..."}
                              </p>
                            </motion.div>
                          )}
                            ...
                            >
                              ...
                              <div className="grid grid-cols-2 gap-3">
                                <div>
                                  ...
                                  <p
                                    className={`text-lg font-bold ${getRiskColor(results[fileId].final.risk_color)}`}
                                  >
                                    {results[fileId].final.risk_score.toFixed(
                                      1,
                                    )}
                                    /100
                                  </p>
                              ...
                              <div className="bg-black/40 rounded p-3 border border-green-500/10">
                                ...
                                <p className="text-gray-300 text-xs leading-relaxed">
                                  {results[fileId].layer3_scoring?.reasoning ||
                                    results[fileId].final.reasoning}
                                </p>
                              </div>
                          ...
                          <div className="flex gap-2 flex-wrap">
                            ...
                            {hasResult && (
                              <>
                                ...
                                <button
                                  onClick={() => {
                                    const filename = `${file.filename}-report.pdf`;
                                    generatePDFReport(results[fileId], filename);
                                  }}
                                  className="py-2 px-3 bg-blue-500/20 border border-blue-500 text-blue-400 rounded font-semibold hover:bg-blue-500/30 transition text-sm flex items-center gap-2"
                                ...
                                <button
                                  onClick={() => {
                                    const filename = `${file.filename}-data.json`;
                                    downloadAnalysisJSON(results[fileId], filename);
                                  }}
                                  className="py-2 px-3 bg-purple-500/20 border border-purple-500 text-purple-400 rounded font-semibold hover:bg-purple-500/30 transition text-sm flex items-center gap-2"
                ...
                <div className="bg-black/40 rounded p-4 space-y-3">
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={() =>
                        navigate("/results", {
                          state: { result: results["text_input"] },
                        })
                      }
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Supports: Plain text, email content, URLs, messages, logs,
                  code snippets
                </p>
              </div>
              ...
              {textAnalyzing && (
                ...
                >
                  <div className="grid grid-cols-4 gap-2 mb-3">
                    {["Layer 0", "Layer 1", "Layer 2", "Layer 3"].map(
                      (layer, idx) => {
              ...
              {textResult && !textAnalyzing && (
                ...
                >
                  ...
                  <div className="flex gap-2 flex-wrap">
                    ...
                    <button
                      onClick={() => {
                        generatePDFReport(textResult!, "text_analysis_report.pdf");
                      }}
                      className="py-2 px-3 bg-blue-500/20 border border-blue-500 text-blue-400 rounded font-semibold hover:bg-blue-500/30 transition text-sm flex items-center gap-2"
                      title="Download PDF Report"
                    >
                    ...
                    <button
                      onClick={() => {
                        downloadAnalysisJSON(textResult!, "text_analysis_data.json");
                      }}
                      className="py-2 px-3 bg-purple-500/20 border border-purple-500 text-purple-400 rounded font-semibold hover:bg-purple-500/30 transition text-sm flex items-center gap-2"
                      title="Download JSON Data"
                    >
